create database bd_sistemas_ventas;

use bd_sistemas_ventas;
...
values("Lucas","Abdala","catepecu","123456","03816411006",1);

select usuario, password from tb_usuario 
where usuario = "catepecu" and password="123456";
...
select descripcion from tb_categoria where descripcion='frutas';
